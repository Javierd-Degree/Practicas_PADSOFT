 ...
 *
 */
public class ModificableDate {
	
	// Default initialization. DO NOT CHANGE
	private static LocalDate modificableDate 
	...
	public static void plusDays(int numDays) {
		modificableDate = modificableDate.plusDays(numDays);
	}
	...
	public static LocalDate setDate(int day, int month, int year) {
		modificableDate = modificableDate.withDayOfMonth(day).withMonth(month).withYear(year);
		return modificableDate;
	}
