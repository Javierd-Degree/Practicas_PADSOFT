...
public class HostWindow implements WindowInterface{
	...
	public HostWindow(RegisteredUser user) {
		frame = new JFrame("Host window");
		...
		login.setBorder(BorderFactory.createTitledBorder("Host"));
		...
		historyButton = new JButton("Created");
		historyButton.setActionCommand("CREATED");
